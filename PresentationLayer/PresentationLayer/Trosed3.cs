...
namespace PresentationLayer
{
    ...
    {   
        ...
        private void Trosed3_Load(object sender, EventArgs e)
        {
            GetData();
        }

        private void btKupovina3_Click(object sender, EventArgs e)
        {
