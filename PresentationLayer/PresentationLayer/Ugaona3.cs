...
namespace PresentationLayer
{
    public partial class Ugaona3 : Form
    {
        ...
        private void Ugaona3_Load(object sender, EventArgs e)
        {
            GetData();
        }

        private void btKupovina7_Click(object sender, EventArgs e)
        {
